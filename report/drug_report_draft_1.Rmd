...
There are no legal considerations, because the data used is open source and covered by the Open Government Licencse so it is available to anyone.  Ethical considerations are that the data contains death numbers by alcohol and drugs and causes of death by particular drug.  However the data is anonymised.  
